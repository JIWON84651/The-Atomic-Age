...
// CAMERA_MIN_HEIGHT = 5.0,					defines.lua   (reload defines)
...
static const float GB_THRESHOLD2 = 0.12f; // interpolation time
...
static const float GB_OPACITY_NEAR = 0.8f; // Transparency when camera is near
